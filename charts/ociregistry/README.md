...
Version: v1.8.0, build date: 2025-04-23T00:35:28.79Z
...
![Version: 1.8.0-1](https://img.shields.io/badge/Version-1.8.0--1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.8.0](https://img.shields.io/badge/AppVersion-1.8.0-informational?style=flat-square)
...
| image.ociregistry.tag | string | `"1.8.0"` | The image tag |
