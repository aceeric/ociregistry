...
|`host` | String | 0.0.0.0 | `--host` | E.g. "127.0.0.1". |
...
|`metrics` | Integer | - | `--metrics` | A port number to run a `/metrics` endpoint on for Prometheus. By default, the server doesn't enable or expose metrics. |
